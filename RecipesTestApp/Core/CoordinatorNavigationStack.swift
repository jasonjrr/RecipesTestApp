...
/// *Developer's Note*: This `class` and `View` wrapper add additional flexibility to the
/// `NavigationPath` provided in iOS 17+.
struct CoordinatorNavigationStack<Content>: View where Content : View {
...
@Observable
class CoordinatorNavigationPath {
